...
public class RetrofitServiceManager {
    private static final int DEFAULT_TIME_OUT = 800;//超时时间
    private static final int DEFAULT_READ_TIME_OUT = 800;//读取时间
    private static final int DEFAULT_WRITE_TIME_OUT = 800;//读取时间
