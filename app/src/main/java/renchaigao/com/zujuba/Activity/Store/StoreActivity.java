...
public class StoreActivity extends BaseActivity {
    ...
    private TextView allPlayNum, storeStarsText, storeTeamNum, distance, storeClubNum, store_class,
    ...
    private void updateBasicView() {
        ...
        storeStarsText.setText(String.valueOf(storeActivityBean.getStar()));
...
//                .start();
    ...
    private void reloadAdapter() {
        addSubscribe(RetrofitServiceManager.getInstance().creat(StoreApiService.class)
                .GetOneStoreInfo("one",userId, storeId, token, lastTime)
    ...
    private void setViewPager() {
        ...
        store_info_tablayout.getTabAt(3).setCustomView(tab_icon("游戏"));
    }
