...
import renchaigao.com.zujuba.Activity.TeamPart.CardPlayerAdapter;
...
public class StoreTeamsFragment extends BaseFragment implements CommonViewHolder.onItemCommonClickListener {
    ...
    private LinearLayout store_team_tablayout;
    ...
    protected void InitView(View rootView) {
        store_team_tablayout = (LinearLayout) rootView.findViewById(R.id.store_team_tablayout);
    }
