package renchaigao.com.zujuba.ActivityAndFragment.Message.Adapter;
...
public class SystemMessageInfoAdapter extends CommonRecycleAdapter<AndroidMessageContent> implements MultiTypeSupport<AndroidMessageContent> {

    private Context mContext;
    private CommonViewHolder.onItemCommonClickListener commonClickListener;

    public SystemMessageInfoAdapter(Context context, ArrayList<AndroidMessageContent> dataList, CommonViewHolder.onItemCommonClickListener commonClickListener) {
