...
public class MainStoreFragmentAdapter1 extends RecyclerView.Adapter<MainStoreFragmentAdapter1.ItemHolder> {
    final static String TAG = "MainStoreFragmentAdapter";
//    private ArrayList<StoreInfo> mStore;
    private ArrayList<JSONObject> mJsonObject;
    private Context mContext;

    public MainStoreFragmentAdapter1(Context context) {
...
//    }
    ...
    public class ItemHolder extends RecyclerView.ViewHolder {
        ...
        public ItemHolder(View view) {
            ...
            this.store_time_icon = (ImageView) view.findViewById(R.id.store_time_icon);
            this.store_image = (ImageView) view.findViewById(R.id.store_image);
            this.store_boy_icon = (ImageView) view.findViewById(R.id.store_boy_icon);
            this.store_girl_icon = (ImageView) view.findViewById(R.id.store_girl_icon);
//            this.place_star_num = view.findViewById(R.id.place_star_num);
            this.store_desk_info = (TextView) view.findViewById(R.id.store_desk_info);
            this.store_people_info = (TextView) view.findViewById(R.id.store_people_info);
            this.store_user_evaluate_1 = (TextView) view.findViewById(R.id.store_user_evaluate_1);
            this.store_user_evaluate_2 = (TextView) view.findViewById(R.id.store_user_evaluate_2);
            this.store_user_evaluate_3 = (TextView) view.findViewById(R.id.store_user_evaluate_3);
            this.store_cardview_name = (TextView) view.findViewById(R.id.store_cardview_name);
            this.store_cardview_style = (TextView) view.findViewById(R.id.store_cardview_style);
            this.store_place_howlong = (TextView) view.findViewById(R.id.store_place_howlong);
            this.store_start_time = (TextView) view.findViewById(R.id.store_start_time);
            this.store_store_rank = (TextView) view.findViewById(R.id.store_store_rank);
            this.store_tips = (TextView) view.findViewById(R.id.store_tips);
            this.store_score = (TextView) view.findViewById(R.id.store_score);
            this.store_spend = (TextView) view.findViewById(R.id.store_spend);
            this.c_store_allpeoplenum = (TextView) view.findViewById(R.id.c_store_allpeoplenum);
