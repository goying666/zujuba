...
//
//public class CreateStorePartThreeActivity extends BaseActivity {
//
...
//        userInfo = DataUtil.GetUserInfoData(CreateStorePartThreeActivity.this);
//        user = DataUtil.GetUserData(CreateStorePartThreeActivity.this);
...
//            }
//        });
//        linearLayout_part1 = (LinearLayout) findViewById(R.id.LinearLayout_agreePartLinearLayout);
//
//    }
//
//    //        基础信息部分
//    private void initBasicPart() {
//        business_join_introduce_time_textView_number = (TextView) findViewById(R.id.TextView_sumOfTimeTextView);
//        business_join_basic_button_next = (Button) findViewById(R.id.Button_basicNextButton);
//        linearLayout_part2 = (LinearLayout) findViewById(R.id.LinearLayout_basicPartLinearLayout);
//        business_join_name = (TextInputEditText) findViewById(R.id.TextInputEditText_storeNamTextInputEditText);
//        business_join_class = (AppCompatSpinner) findViewById(R.id.AppCompatSpinner_storeClassAppCompatSpinner);
//        business_join_introduce_addres_image = (ImageView) findViewById(R.id.business_join_introduce_addres_image);
//        business_join_introduce_addres_name = (TextView) findViewById(R.id.TextView_locationTextView);
//        business_join_introduce_addres_addinfo = (TextInputEditText) findViewById(R.id.TextInputEditText_addressNoteTextInputEditText);
...
//        business_join_introduce_time_checkBox1 = (CheckBox) findViewById(R.id.AppCompatCheckBox_timeOneAppCompatCheckBox);
//        business_join_introduce_time_checkBox2 = (CheckBox) findViewById(R.id.AppCompatCheckBox_timeTwoAppCompatCheckBox);
//        business_join_introduce_time_checkBox3 = (CheckBox) findViewById(R.id.AppCompatCheckBox_timeThreeAppCompatCheckBox);
//        business_join_introduce_time_checkBox4 = (CheckBox) findViewById(R.id.AppCompatCheckBox_timeFourAppCompatCheckBox);
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(CreateStorePartThreeActivity.this, GaoDeMapActivity.class);
...
//        business_join_detail_button_back = (Button) findViewById(R.id.Button_backButton);
//        business_join_detail_button_next = (Button) findViewById(R.id.Button_nextButton);
//        linearLayout_part3 = (LinearLayout) findViewById(R.id.business_join_introduce_part3);
//        business_join_desk_layout = (TextInputLayout) findViewById(R.id.TextInputLayout_deskTextInputLayout);
//        business_join_maxpeople_layout = (TextInputLayout) findViewById(R.id.TextInputLayout_maxNumberTextInputLayout);
//        business_join_desk_num = (TextInputEditText) findViewById(R.id.TextInputEditText_deskTextInputEditText);
//        business_join_maxpeople_num = (TextInputEditText) findViewById(R.id.TextInputLayout_maxNumberTextInputLayout);
...
//                else
//                    Toast.makeText(CreateStorePartThreeActivity.this, "请完善所有图片", Toast.LENGTH_LONG).show();
//            }
//        });
//    }
//
...
//        progDialog = new ProgressDialog(CreateStorePartThreeActivity.this);
...
//            public void onClick(DialogInterface dialog, int which) {
//                reloadAdapter();
//                Toast.makeText(CreateStorePartThreeActivity.this, "你点击了确定发送", Toast.LENGTH_LONG).show();
//            }
//        });
...
//            Toast.makeText(CreateStorePartThreeActivity.this, str, Toast.LENGTH_SHORT).show();
//        }
//
//        ;
//    };
...
//                .subscribeWith(new BaseObserver<ResponseEntity>(CreateStorePartThreeActivity.this) {
//                    @Override
...
//        } else {
//            imageUri = FileProvider.getUriForFile(CreateStorePartThreeActivity.this, "com.example.cameraalbumtest.fileprovider", outputImage);
//        }
//        // 启动相机程序
