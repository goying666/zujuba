...
public class MainMessageFragmentAdapter extends CommonRecycleAdapter<CardMessageFragmentTipBean> implements MultiTypeSupport<CardMessageFragmentTipBean> {

    private CommonViewHolder.onItemCommonClickListener commonClickListener;
    private Context mContext;

    public MainMessageFragmentAdapter(Context context, ArrayList<CardMessageFragmentTipBean> dataList, int layoutId) {
        super(context, dataList, layoutId);
    }

    public MainMessageFragmentAdapter(Context context, ArrayList<CardMessageFragmentTipBean> dataList,
