...
public class TeamMessageInfoAdapter extends CommonRecycleAdapter<AndroidMessageContent> implements MultiTypeSupport<AndroidMessageContent> {

    private Context mContext;
    private CommonViewHolder.onItemCommonClickListener commonClickListener;

    public TeamMessageInfoAdapter(Context context, ArrayList<AndroidMessageContent> dataList, CommonViewHolder.onItemCommonClickListener commonClickListener) {
