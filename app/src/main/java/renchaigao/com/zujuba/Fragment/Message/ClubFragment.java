...
public class ClubFragment extends BaseFragment implements CommonViewHolder.onItemCommonClickListener {
    ...
    public void UpdateViewData() {
        clubFragmentAdapter.updateResults(displayTipCardBeanList);
        clubFragmentAdapter.notifyDataSetChanged();
    }
    ...
    private void setRecyclerView(View view) {
        ...
        recyclerView.setAdapter(clubFragmentAdapter);
