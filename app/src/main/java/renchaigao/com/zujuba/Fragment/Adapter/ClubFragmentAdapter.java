...
public class ClubFragmentAdapter extends CommonRecycleAdapter<CardMessageFragmentTipBean> implements MultiTypeSupport<CardMessageFragmentTipBean> {

    private CommonViewHolder.onItemCommonClickListener commonClickListener;
    private Context mContext;

    public ClubFragmentAdapter(Context context, ArrayList<CardMessageFragmentTipBean> dataList, int layoutId) {
        super(context, dataList, layoutId);
    }

    public ClubFragmentAdapter(Context context, ArrayList<CardMessageFragmentTipBean> dataList, CommonViewHolder.onItemCommonClickListener commonClickListener) {
